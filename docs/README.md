...
- [domain-model.md](domain-model.md) — ubiquitous language (Song, User Song, Recording, etc.) and *why* the model is shaped this way. Read this before touching naming or data model in code.
