    ...
    <div className="lg:flex lg:h-screen">
      ...
      <div className="flex-1 flex lg:h-screen lg:overflow-hidden">
        <div
          ...
          } inset-x-0 top-0 bottom-0 z-10 overflow-y-auto pb-16 bg-merino-100 lg:block lg:static lg:inset-auto lg:z-auto lg:w-96 lg:shrink-0 lg:h-full lg:overflow-y-auto lg:pb-0 lg:border-r-2 lg:border-line-100`}
        >
          <MiddlePaneGate />
        </div>
