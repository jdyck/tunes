...
export default function RecordingPaneWrapper({
  ...
  return (
    <div className="fixed inset-x-0 top-0 bottom-0 z-30 overflow-y-auto overscroll-none bg-merino-100 pt-[env(safe-area-inset-top)] pb-[calc(4rem+env(safe-area-inset-bottom))] lg:absolute lg:left-auto lg:right-0 lg:top-0 lg:bottom-0 lg:block lg:w-96 lg:h-full lg:overflow-y-auto lg:pt-0 lg:pb-0 lg:border-l lg:border-line-100 lg:shadow-[-12px_0_24px_rgba(32,29,27,0.12)] min-[95.25rem]:static min-[95.25rem]:inset-auto min-[95.25rem]:z-auto min-[95.25rem]:shrink-0 min-[95.25rem]:shadow-none">
      {children}
    </div>
  );
}
