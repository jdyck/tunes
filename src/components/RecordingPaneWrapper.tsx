...
export default function RecordingPaneWrapper({
  ...
  return (
    <div className="fixed inset-x-0 top-0 bottom-0 z-30 overflow-y-auto pb-16 lg:static lg:inset-auto lg:z-auto lg:block lg:w-96 lg:shrink-0 lg:h-full lg:overflow-y-auto lg:pb-0 lg:border-l lg:border-line-100">
      {children}
    </div>
  );
}
